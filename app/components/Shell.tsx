...
export function Shell({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const writeMotion = () => {
      ...
      const planePerspectiveX = 50 + x * 15;
      const planePerspectiveY = 53 + y * 10;
      const headerPerspectiveX = 50 + x * 13;
      const headerPerspectiveY = 47 + y * 9;
      ...
      root.style.setProperty("--background-plane-rotate-x", `${(-y * 13.8).toFixed(3)}deg`);
      root.style.setProperty("--background-plane-rotate-y", `${(x * 15.6).toFixed(3)}deg`);
      root.style.setProperty("--background-plane-shift-x", `${(-x * 0.8).toFixed(2)}px`);
      root.style.setProperty("--background-plane-shift-y", `${(-y * 0.6).toFixed(2)}px`);
      root.style.setProperty("--background-plane-drift-x", `${(-x * 0.08).toFixed(2)}px`);
      root.style.setProperty("--background-plane-drift-y", `${(-y * 0.06).toFixed(2)}px`);
      root.style.setProperty("--background-plane-drift-soft-x", `${(-x * 0.04).toFixed(2)}px`);
      root.style.setProperty("--background-plane-drift-soft-y", `${(-y * 0.035).toFixed(2)}px`);
      root.style.setProperty("--background-header-before-rotate-x", `${(-y * 9.6).toFixed(3)}deg`);
      root.style.setProperty("--background-header-before-rotate-y", `${(x * 10.4).toFixed(3)}deg`);
      root.style.setProperty("--background-header-after-rotate-x", `${(-y * 7.2).toFixed(3)}deg`);
      root.style.setProperty("--background-header-after-rotate-y", `${(x * 7.8).toFixed(3)}deg`);
      root.style.setProperty("--background-header-shift-x", `${(-x * 8.4).toFixed(2)}px`);
      root.style.setProperty("--background-header-shift-y", `${(-y * 6.2).toFixed(2)}px`);
      root.style.setProperty("--background-header-shift-soft-x", `${(-x * 4.6).toFixed(2)}px`);
      root.style.setProperty("--background-header-shift-soft-y", `${(-y * 3.6).toFixed(2)}px`);
      root.style.setProperty("--background-hero-edge-rotate-x", `${(-y * 7.4).toFixed(3)}deg`);
      root.style.setProperty("--background-hero-edge-rotate-y", `${(x * 8.2).toFixed(3)}deg`);
      root.style.setProperty("--background-hero-motif-rotate-x", `${(-y * 8.4).toFixed(3)}deg`);
      root.style.setProperty("--background-hero-motif-rotate-y", `${(x * 9.3).toFixed(3)}deg`);
      root.style.setProperty("--background-hero-shift-x", `${(-x * (5.8 + absY * 1.1)).toFixed(2)}px`);
      root.style.setProperty("--background-hero-shift-y", `${(-y * (4.8 + absX * 0.9)).toFixed(2)}px`);
