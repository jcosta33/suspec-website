  ...
  useEffect(() => {
    ...
    const applyPointerMotion = () => {
      ...
      setPointerMotion(root, {
        ...
        "--background-plane-origin-x": `${50 + normalX * 5}%`,
        "--background-plane-origin-y": `${52 + normalY * 4}%`,
        "--background-plane-tilt-x": `${(-normalY * 3.8).toFixed(3)}deg`,
        "--background-plane-tilt-y": `${(normalX * 4.2).toFixed(3)}deg`,
        "--background-plane-drift-x": `${(normalX * 1.4).toFixed(3)}px`,
        "--background-plane-drift-y": `${(normalY * 1.1).toFixed(3)}px`,
        "--background-plane-grid-x": `${(normalX * 1.4).toFixed(3)}px`,
        "--background-plane-grid-y": `${(normalY * 1.1).toFixed(3)}px`,
        "--background-plane-grid-minor-x": `${(normalX * 0.7).toFixed(3)}px`,
        "--background-plane-grid-minor-y": `${(normalY * 0.55).toFixed(3)}px`,
        "--background-header-origin-x": `${50 + normalX * 6}%`,
        "--background-header-origin-y": `${46 + normalY * 4}%`,
        "--background-header-drift-x": `${(normalX * 8).toFixed(3)}px`,
        "--background-header-drift-y": `${(normalY * 5).toFixed(3)}px`,
        "--background-header-tilt-x": `${(-normalY * 2.1).toFixed(3)}deg`,
        "--background-header-tilt-y": `${(normalX * 2.45).toFixed(3)}deg`,
        "--background-header-grid-x": `${(normalX * 7).toFixed(3)}px`,
        "--background-header-grid-y": `${(normalY * 5).toFixed(3)}px`,
        "--background-header-before-rotate-x": `${(-normalY * 2.35).toFixed(3)}deg`,
        "--background-header-before-rotate-y": `${(normalX * 2.8).toFixed(3)}deg`,
        "--background-header-after-rotate-x": `${(-normalY * 1.7).toFixed(3)}deg`,
        "--background-header-after-rotate-y": `${(normalX * 2.1).toFixed(3)}deg`,
        "--background-hero-edge-rotate-x": `${(-normalY * 1.9).toFixed(3)}deg`,
        "--background-hero-edge-rotate-y": `${(normalX * 2.2).toFixed(3)}deg`,
        "--background-hero-motif-rotate-x": `${(-normalY * 1.55).toFixed(3)}deg`,
        "--background-hero-motif-rotate-y": `${(normalX * 1.8).toFixed(3)}deg`,
      });
    };
