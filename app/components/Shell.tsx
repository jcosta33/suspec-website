...
export function Shell({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const writeMotion = () => {
      ...
      const originY = 52 + y * 7;

      root.style.setProperty("--background-plane-origin-x", `${originX}%`);
      root.style.setProperty("--background-plane-origin-y", `${originY}%`);
      root.style.setProperty("--background-header-origin-x", `${50 + x * 9}%`);
      root.style.setProperty("--background-header-origin-y", `${46 + y * 7}%`);
      root.style.setProperty("--background-plane-normal-x", x.toFixed(3));
      root.style.setProperty("--background-plane-normal-y", y.toFixed(3));
      root.style.setProperty("--background-plane-rotate-x", `${(-y * 7.2).toFixed(3)}deg`);
      root.style.setProperty("--background-plane-rotate-y", `${(x * 8.4).toFixed(3)}deg`);
      root.style.setProperty("--background-plane-shift-x", `${(-x * 4.5).toFixed(2)}px`);
      root.style.setProperty("--background-plane-shift-y", `${(-y * 3.6).toFixed(2)}px`);
      root.style.setProperty("--background-plane-drift-x", `${(-x * 2.5).toFixed(2)}px`);
      root.style.setProperty("--background-plane-drift-y", `${(-y * 2).toFixed(2)}px`);
      root.style.setProperty("--background-plane-drift-soft-x", `${(-x * 1.25).toFixed(2)}px`);
      root.style.setProperty("--background-plane-drift-soft-y", `${(-y * 1).toFixed(2)}px`);
      root.style.setProperty("--background-header-before-rotate-x", `${(-y * 4.4).toFixed(3)}deg`);
      root.style.setProperty("--background-header-before-rotate-y", `${(x * 5).toFixed(3)}deg`);
      root.style.setProperty("--background-header-after-rotate-x", `${(-y * 3.1).toFixed(3)}deg`);
      root.style.setProperty("--background-header-after-rotate-y", `${(x * 3.6).toFixed(3)}deg`);
      root.style.setProperty("--background-header-shift-x", `${(-x * 8).toFixed(2)}px`);
      root.style.setProperty("--background-header-shift-y", `${(-y * 6).toFixed(2)}px`);
      root.style.setProperty("--background-header-shift-soft-x", `${(-x * 4.8).toFixed(2)}px`);
      root.style.setProperty("--background-header-shift-soft-y", `${(-y * 3.8).toFixed(2)}px`);
      root.style.setProperty("--background-hero-edge-rotate-x", `${(-y * 3).toFixed(3)}deg`);
      root.style.setProperty("--background-hero-edge-rotate-y", `${(x * 3.4).toFixed(3)}deg`);
      root.style.setProperty("--background-hero-motif-rotate-x", `${(-y * 3.6).toFixed(3)}deg`);
      root.style.setProperty("--background-hero-motif-rotate-y", `${(x * 4.2).toFixed(3)}deg`);
      root.style.setProperty("--background-hero-shift-x", `${(-x * (6 + absY * 2)).toFixed(2)}px`);
      root.style.setProperty("--background-hero-shift-y", `${(-y * (4.8 + absX * 1.8)).toFixed(2)}px`);
