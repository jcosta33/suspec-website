...
export const signalRoleMeta = {
  ...
  reference: {
    ...
    wheel: "+136° from core",
    tone: "verdigris reference",
    use: "Docs, manuals, command catalogs, indexes, loaders, and read-only rosters.",
    surface: "source notes and reference shelves",
    pattern: "horizontal reference rules",
