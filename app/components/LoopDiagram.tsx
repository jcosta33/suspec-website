...
export function LoopDiagram({
  ...
  // The inscribed triangle, drawn through the hexagon's alternate vertices. It stands
  // for the three keys — intent · review · findings (the mark is symbolic, not vertex-mapped).
      ...
      <div className="loop-diagram-summary panel-raised grid min-w-0 max-w-full gap-8 p-5 md:grid-cols-[18rem_1fr] md:items-center">
        ...
        <div className="loop-diagram-copy min-w-0">
          ...
          <p className="mt-3 max-w-full text-sm leading-relaxed text-concrete-400 sm:max-w-2xl">
            ...
            keys — intent, review, findings: present on virtually every change,
            at whatever weight it earns. Work named, evidence
