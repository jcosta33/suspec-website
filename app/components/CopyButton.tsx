...
export function CopyButton({
  ...
  return (
    <button
      ...
      className={`copy-button focus-ring rounded-control inline-flex min-h-10 items-center gap-1 border border-panel-border bg-panel-recessed/80 px-2 py-1 font-mono text-[0.56rem] font-bold uppercase leading-none tracking-[0.07em] text-concrete-300 transition-[background-color,border-color,color,box-shadow] ${className}`}
