...
| `app/docs/docs-shell.css`, `app/docs/docs-article.css`, `app/docs/docs-article-*.css`, `app/docs/docs-index.css`, `app/docs/docs-footer.css`, `app/docs/docs-responsive.css`, `app/styles/docs-index-polish.css`, `app/styles/mobile-docs-index-polish.css` | Docs shell, rendered markdown, article subfamilies, index, footer, docs-specific responsive fixes, and late docs-index polish imported only under the docs layout manifest. |
